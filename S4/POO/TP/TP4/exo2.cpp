...
class audio_text_t :public audio_doc_t, textual_doc_t{
  public : void print(){
    printf("audio_text_t(%s,%d,%d)",this->audio_doc_t::get_name(),this->audio_doc_t::get_year(),this->get_duration());
  }
};
...
int main(int argc, char const *argv[]) {
  ...
  audioText1.audio_doc_t::set_name((char*)"Harry Potter and the Philosopher's Stone");
  audioText1.audio_doc_t::set_year(1997);
  audioText1.audio_doc_t::set_duration(18000);
  ...
  dvd1.println();
  bluray1.println();
  audioText1.audio_doc_t::println();
